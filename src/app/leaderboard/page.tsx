          ...
          <div className="space-y-3 pb-20">
             {loading ? (
               <div className="flex flex-col items-center justify-center py-20 gap-4">
                 ...
                 <p className="font-bold text-gray-400">Đang tải bảng xếp hạng...</p>
               </div>
             ) : (
                  ...
                  return (
                     <motion.div key={user.id} 
                      ...
                      >
                        ...
                        {/* Avatar */}
                        <div className="w-14 h-14 rounded-2xl flex items-center justify-center text-3xl shadow-inner border-2 border-white overflow-hidden"
                        ...
                        <div className="flex-1 min-w-0">
                           ...
                           <div className="flex items-center gap-3 text-sm font-bold" style={{ color: "var(--text-muted)" }}>
                             <span className="flex items-center gap-1"><Star size={14} className="text-yellow-500 fill-yellow-500" /> {user.streakDays || 0} ngày</span>
                           </div>
                        </div>
